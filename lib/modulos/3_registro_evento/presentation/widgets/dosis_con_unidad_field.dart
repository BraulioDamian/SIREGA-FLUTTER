...
class _DosisConUnidadFieldState extends State<DosisConUnidadField> {
  ...
  Widget build(BuildContext context) {
    final decoration = (widget.baseDecoration ??
            InputDecoration(
              labelText: 'Dosis',
              hintText: '0.0',
              prefixIcon: Icon(Icons.science_outlined, color: widget.accentColor),
                  ...
                  child: Row(
                    children: [
                      if (widget.selectedUnit == unit)
                        Icon(Icons.check_rounded, size: 18, color: widget.accentColor)
                      else
