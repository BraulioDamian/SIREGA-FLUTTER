      ...
      child: Column(
        ...
        children: [
          _buildInfoRow(
            ...
            label: 'Sexo',
            value: animal.sexo.name.replaceFirst(
                animal.sexo.name[0], animal.sexo.name[0].toUpperCase()),
            iconColor: animal.sexo == Sexo.macho ? Colors.blue : Colors.pink,
          ),
          ...
          _buildInfoRow(
            ...
            icon: Icons.cake,
            label: 'Edad',
            value: animal.getEdadFormateada(),
          ),
          const Divider(height: 24),
          _buildInfoRow(
            context,
