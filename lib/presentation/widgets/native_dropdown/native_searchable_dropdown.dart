...
class _NativeSearchableDropdownState<T extends Object>
    extends State<NativeSearchableDropdown<T>>
  ...
  OverlayEntry _createOverlay() {
    ...
    final spaceAbove = fieldOffset.dy - topPadding;
    final spaceBelowAvailable =
    ...
    const double minPixelsVisible = 36;
                  ...
                  child: Material(
                    ...
                    child: Container(
                      ...
                      child: itemsCopy.isEmpty
                          ? _buildEmptyState()
                          : _buildItemList(itemsCopy, size.width),
                    ),
                  ),
                );
              },
  ...
  Widget _buildItemList(List<T> items, double maxWidth) {
    return ClipRect(
                ...
                icon: AnimatedRotation(
                  ...
                  child: Icon(
                    ...
                    color: widget.enabled
                        ? (_isOpen ? theme.primaryColor : Colors.grey.shade700)
                        : Colors.grey,
                  ),
                ),
              ),
