...
class CustomSliverHeader extends StatelessWidget {
          ...
          Positioned(
            ...
            child: AnimatedOpacity(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: animal.healthStatus.color,
                  shape: BoxShape.circle,
                  boxShadow: [
                    BoxShadow(
                      color: animal.healthStatus.color.withValues(alpha: 0.5),
                      blurRadius: 12,
  ...
  Widget _buildImage() {
    if (animal.profilePhotoUrl != null && animal.profilePhotoUrl!.isNotEmpty) {
      return Image.file(
        File(animal.profilePhotoUrl!),
        fit: BoxFit.cover,
