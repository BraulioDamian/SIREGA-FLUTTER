...
class MedicalEventCard extends StatelessWidget {
  final MedicalEventRecord evento;
  final int index;
  final bool isLast;
                                    ...
                                    children: [
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            evento.esAplicacionUnica
                                                ? AnimalDetailHelpers.formatDateVerbose(
                                                    evento.date,
                                                  )
                                      ...
                                      Wrap(
                                        ...
                                        children: [
                                          ...
                                          // Dosis
                                          if (evento.dose != null &&
                                              evento.doseUnit != null)
                                            _infoPill(
                                              '${evento.dose} ${evento.doseUnit}',
                                              AppColors.textSecondary,
                                            ),

                                          // Vía de administración
                                          if (evento.applicationRoute != null &&
                                              evento
                                                  .applicationRoute!
                                                  .isNotEmpty)
                                            _infoPill(
                                              evento.applicationRoute!,
                                              AppColors.textSecondary,
                                              icon: Icons.vaccines_outlined,
                                            ),

                                          // Veterinario
                                          if (evento.veterinarian != null &&
                                              evento.veterinarian!.isNotEmpty)
                                            _infoPill(
                                              'Dr(a). ${evento.veterinarian}',
                                              AppColors.textSecondary,
                                      ...
                                      // Notes preview
                                      if (evento.notes != null &&
                                          evento.notes!.isNotEmpty)
                                        Padding(
...
class _EventDetailsSheet extends StatelessWidget {
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: Icon(tipo.icon, color: Colors.white, size: 32),
                  ),
            ...
            Padding(
              ...
              child: Column(
                children: [
                  _buildDetailRow(
                    'Fecha',
                    AnimalDetailHelpers.formatDateVerbose(evento.date),
                    Icons.calendar_today,
                  ),
                  if (evento.dose != null && evento.doseUnit != null)
                    _buildDetailRow(
                      'Dosis',
                      '${evento.dose} ${evento.doseUnit}',
                  ...
                  if (evento.applicationRoute != null &&
                      evento.applicationRoute!.isNotEmpty)
                    _buildDetailRow(
                      'Vía de administración',
                      evento.applicationRoute!,
                  ...
                  if (evento.nextApplicationDate != null)
                    _buildDetailRow(
                      'Próxima aplicación',
                      AnimalDetailHelpers.formatDateVerbose(
                        evento.nextApplicationDate!,
                      ),
  ...
  void _showDeleteConfirmation(BuildContext sheetContext) {
    ...
    final name = evento.productName ?? 'este registro';
    final fechaStr = AnimalDetailHelpers.formatDateVerbose(evento.date);
    ...
    try {
      ...
      if (sheetContext.mounted) {
        ...
        ScaffoldMessenger.of(parentContext).showSnackBar(
          SnackBar(
            content: Text('${evento.productName ?? "Registro"} eliminado'),
  ...
  Widget _buildVacunaInfoSection() {
    final info = CatalogoVacunas.buscarPorNombre(evento.productName ?? '');
