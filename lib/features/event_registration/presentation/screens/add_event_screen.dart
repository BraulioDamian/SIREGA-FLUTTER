...
import 'package:sirega_app/features/event_registration/presentation/bloc/add_event_bloc.dart';
...
class _AddEventScreenState extends State<AddEventScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<AddEventBloc>(
      ...
      child: Scaffold(
        appBar: AppBar(title: Text('Evento para ${widget.animal.name}')),
                  ...
                  Card(
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text('Animal: ${widget.animal.name}'),
                          Text('Raza: ${widget.animal.breed}'),
                        ],
                      ),
                    ),
                  ),
                                  ...
                                  if (_formKey.currentState!.validate()) {
                                    context.read<AddEventBloc>().add(
                                      SaveEvent(
                                        ...
                                        notes: _notasController.text.isEmpty
                                            ? null
