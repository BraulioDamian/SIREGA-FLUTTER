...
class EventResultScreen extends StatefulWidget {
  ...
  const EventResultScreen({super.key, required this.animalCount});

  @override
  State<EventResultScreen> createState() => _ResultadoEventoScreenState();
}

class _ResultadoEventoScreenState extends State<EventResultScreen>
