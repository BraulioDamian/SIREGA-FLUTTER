...
class ProductTypeAheadField extends StatelessWidget {
  ...
  static const Map<TipoEvento, List<String>> _refuerzos = {
    ...
    TipoEvento.desparasitante: ['Rotación de Desparasitante (Semestral)'],
  };
  ...
  Widget build(BuildContext context) {
    return TypeAheadField<String>(
      ...
      suggestionsCallback: (pattern) {
        final suggestions = _sugerencias[type] ?? [];
        final reinforcements = _refuerzos[type] ?? [];
