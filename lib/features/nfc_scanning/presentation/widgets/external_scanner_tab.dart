...
import 'package:sirega_app/features/nfc_scanning/presentation/widgets/scan_result_widget.dart';
import 'package:sirega_app/features/nfc_scanning/presentation/widgets/connection_widgets.dart'
    as connection;
  ...
  Widget _buildContent(
    ...
    if (state is Esp32Error) {
      return connection.ScanErrorWidget(
        ...
        onOpenWifiSettings: state.connectionMode == Esp32ConnectionMode.wifi
            ? () =>
                  context.read<Esp32ScannerBloc>().add(OpenWifiSettingsEvent())
            : null,
      );
    }
        ...
        child: Column(
          ...
          children: [
            connection.ConnectionStatusWidget(
              ...
              onDisconnect: () => context.read<Esp32ScannerBloc>().add(
                DisconnectFromEsp32Event(),
              ),
            ),
            const SizedBox(height: 32),
            Container(
